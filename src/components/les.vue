		...
		<div class="container" id="app">
			...
			<nav class="row col-md-12">
				...
				<div class="form-group col-md-3">
					<form>
						<input class="form-control" type="search" placeholder="Search" aria-label="Search" v-model="cari">
...
<script>
	...
	export default {
		...
		created() {
			axios.get("http://localhost:3000/api/les").then((res) => {
				this.hargaLes = res.data;
